<template>
  <div>
    ...
    <generic-input label="Ángulo">
      <input type="range" min="0" max="90" step="1" v-model="status.pendulum.angle"
            @change="setStatus" class="slider is-small">
      <span v-text="status.pendulum.angle"></span>
    </generic-input>

    <generic-input label="Masa">
      <input type="range" min="2" max="4" step="0.5" v-model="status.pendulum.mass"
            @change="setStatus" class="slider is-small">
      <span v-text="status.pendulum.mass"></span>
    </generic-input>

    <generic-input label="Paso">
      <input type="range" min="0.01" max="0.3" step="0.005" v-model="status.step"
            @change="setStatus" class="slider is-small">
